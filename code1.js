...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13327540);
}
}
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13333244);
}
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Modulo_321Code.GDHandRObjects1.length;i<l;++i) {
    if ( gdjs.Modulo_321Code.GDHandRObjects1[i].getBehavior("Tween").hasFinished("FadeOutHandR") ) {
        isConditionTrue_0 = true;
        gdjs.Modulo_321Code.GDHandRObjects1[k] = gdjs.Modulo_321Code.GDHandRObjects1[i];
        ++k;
    }
}
gdjs.Modulo_321Code.GDHandRObjects1.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.Modulo_321Code.GDHandRObjects1 */
{for(var i = 0, len = gdjs.Modulo_321Code.GDHandRObjects1.length ;i < len;++i) {
